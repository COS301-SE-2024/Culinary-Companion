  ...
  Widget _buildInstructionalContent(Color fontColor) {
    return Column(
      ...
      children: [
        ...
        _buildStep(
            '1',
            'Select the appropriate tab (Add Recipe PDF, Paste Recipe, or Add My Own Recipe) to start adding your recipe.',
            fontColor),
        _buildStep(
            '2',
            'Use the "Add Recipe PDF" tab to add a recipe pdf file.',
            fontColor),
        _buildStep(
            '3',
