  ...
  Widget _buildInstructionalContent(Color fontColor) {
    return Column(
      ...
      children: [
        ...
        _buildParagraph(
            'The appliance page is where you can add all your available appliances. Here’s how you can navigate and use it effectively:',
            fontColor),
        _buildStep(
            '1', 'Tap the "+" button at the bottom of the screen.', fontColor),
        _buildStep(
            '2', 'Enter the appliance name in appliance field.', fontColor),
        _buildStep('3', 'Tap "Add" to add the appliance.', fontColor),
        _buildStep('4', 'To delete an appliance, locate the appliance you wish to remove and tap the trash can icon next to the appliance to delete it.', fontColor),
      ],
    );
  }
