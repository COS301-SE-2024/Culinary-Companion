                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            '1.2. Enter the appliance name in appliance field.\n'
                            '1.3. Tap "Add" to add the appliance.',
                          ),
                          ...
                          SizedBox(height: 8.0),
                          Text(
                            '1.4. Locate the appliance you wish to remove.\n'
                            '1.5. Tap the trash can icon next to the appliance.\n',
                          ),
                          SizedBox(height: 20),
                          Text(
