...
Deno.serve(async (req) => {
    ...
    try {
        const { action, userId, recipeData, ingredientName, course, spiceLevel, cuisine, category, recipeid, applianceName, quantity,measurementUnit, searchTerm, keywords } = await req.json();
